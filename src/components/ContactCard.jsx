...
const ContactCard = ({ product }) => {
  const ownerEmail = "edge2mtr@gmail.com";
  ...
  const handleWhatsApp = () => {
    const message = `Hi, I'm interested in ${product.title} (${product.category})`;
  ...
  const body = `Hi,\n\nI'm interested in ${product.title} (${product.category}) at EDGE2 MTR.\n\nPlease provide more details regarding availability and price.\n\nThank you.`;
