...
const AboutPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{content.about?.title} | EDGE2 MTR</title>
        <meta name="description" content="Learn about EDGE2 MTR's mission to provide pure, synthetic-free organic products. Family-run, health-focused, and quality-driven." />
      </Helmet>
