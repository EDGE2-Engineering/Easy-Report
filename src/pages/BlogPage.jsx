...
const BlogPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Blog | EDGE2 MTR</title>
        <meta name="description" content="Stay updated with the latest news, healthy tips, and organic living insights from EDGE2 MTR." />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Discover healthy living tips, organic recipes, and benefits of pure farm-to-table products from EDGE2 MTR.
            </p>
          </motion.div>
